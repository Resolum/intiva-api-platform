 ...
 * @param transactionId The identifier of the transaction to be updated, represented as a long value. This field is mandatory and must correspond to an existing transaction in the system.
