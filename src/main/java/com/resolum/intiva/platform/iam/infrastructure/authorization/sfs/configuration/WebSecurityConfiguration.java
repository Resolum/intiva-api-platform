package com.resolum.intiva.platform.iam.infrastructure.authorization.sfs.configuration;

import com.resolum.intiva.platform.iam.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter;
...
/**
 * WebSecurityConfiguration is a configuration class that sets up the security settings for the application.
 * It defines beans for authentication, authorization, and security filters, and configures the HTTP security settings.
 */
@Configuration
