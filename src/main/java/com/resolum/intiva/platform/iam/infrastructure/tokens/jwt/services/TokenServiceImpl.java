package com.resolum.intiva.platform.iam.infrastructure.tokens.jwt.services;
...
public class TokenServiceImpl implements BearerTokenService {
    ...
    // Expiration time for the JWT token in days, injected from application.properties
