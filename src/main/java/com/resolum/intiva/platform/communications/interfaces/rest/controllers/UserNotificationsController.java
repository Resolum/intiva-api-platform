...
@Tag(name = "Users", description = "Endpoints related to user notifications management")
public class UserNotificationsController {
     ...
     */
    public UserNotificationsController(NotificationQueryService notificationQueryService) {
